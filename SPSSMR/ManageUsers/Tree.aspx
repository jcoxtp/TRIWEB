<%@ Page language="c#" Codebehind="Tree.aspx.cs" Inherits="ManageUsers.Tree"  %>
		...
		<script language="javascript">
			function refreshInfo()
			{
			    try
			    {
				    ...
				    if (window.top.frames.main.document.mainFrm != null)
				        window.top.frames.main.document.mainFrm.src = window.top.frames.main.document.mainFrm.src;
			    }
			    catch(err) {}
			}
		</script>
