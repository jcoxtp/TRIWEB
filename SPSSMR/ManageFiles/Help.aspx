<%@ Page language="c#" Codebehind="Help.aspx.cs" AutoEventWireup="false" Inherits="ManageFiles.Help" %>
...
<html>
	...
	* Copyright © 2003 SPSS Ltd. All rights reserved.
	...
	<head>
		<title>
			<%=Server.HtmlEncode(ManageFiles.Utilities.I18N.GetResourceString("help_dialog_title"))%>
		</title>
