<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuestionYesNo.aspx.cs" 

Inherits="UploadFile.QuestionYesNo" %>
...
<img style="filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0);" src="Image/Question.png" border="0" alt="">
                ...
                <tr>
						<TD align="center" colspan=2><BR>
							<INPUT  id="btnYes" onclick="closeWindowWithYes();" 
type="button" name="btnYes" value=<%= GetBtnYesText() %> style="width:80px"  />  &nbsp;
							<INPUT  id="btnNo" onclick="closeWindowWithNo();" 
type="button" name="btnNo" value=<%=GetBtnNoText() %> style="width:80px"  
					>&nbsp;</TD>					
                </tr>
            </table>  
        </asp:Panel>
