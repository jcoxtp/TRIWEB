...
' Set initial critical page parameters
	...
	intPageID = 16	' PDI App Report Teamwork Page
%>
...
<table class="addtable" border="0" cellspacing="0" cellpadding="6" width="100%">
	<tr>
		...
		<td valign="top">
			<h2><%=strTextTeamWorkWithStyleRegMark%></h2>
			<p><%=strTextTeamWorkWithStylePar1%></p>
		</td>
	</tr>
</table>
...
<table class="addtable" border="0" cellspacing="0" cellpadding="3" width="450">
	...
	<tr>
		<td valign="middle" align="center"><a href="javascript:openAnyWindow('PDIAppReportsTeamWorkSample1.asp?res=<%=intResellerID%>','Sample',525,560)"><img src="images/teamworkstyle_sample1_sm.gif" class="imageborder" alt="" width="200" height="254" /></a><br />
			<span class="captiontext"><%=strTextClickImageForEnlargedView%></span>
		</td>
		<td valign="middle" align="center"><a href="javascript:openAnyWindow('PDIAppReportsTeamWorkSample2.asp?res=<%=intResellerID%>','Sample',525,560)"><img src="images/teamworkstyle_sample2_sm.gif" class="imageborder" alt="" width="200" height="254" /></a><br />
			<span class="captiontext"><%=strTextClickImageForEnlargedView%></span>
		</td>
	</tr>
</table>
