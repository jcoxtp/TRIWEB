		...
		<%
			...
			If intPurchaseID > 0 and intProfileMgr > 0 then
				...
				If bolEmailBuyer or bolEmailProfileMgr Then
					...
					strFromName = "Triaxia Partners-PDIProfile.com"
				...
				'-- Build the email body ------
					...
					strBody = strBody & "5. At the end of the assessment (step 6) you can create and download the Adobe PDF report of the DISC Inventory by clicking on the 'Create Report' icon." & vbCrLf
