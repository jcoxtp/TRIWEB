		...
		<%
			If bFilledOutProperly Then
				...
				If oConn.Errors.Count < 1 then
					Dim intSales, intDisc, intCommis, intDiscSales, intItemsSold, intPDIP, intPDDG, intSELL, intCOMM, intTEAM, intLEAD, intTIME, intDRMA, intFINP
					intSales = 0 : intDisc = 0 : intCommis = 0 : intDiscSales = 0 : intItemsSold = 0 : intPDIP = 0 : intPDDG = 0 : intSELL = 0 : intCOMM = 0 : intTEAM = 0 : intLEAD = 0 : intTIME = 0 : intDRMA = 0 : intFINP = 0
					...
					Response.Write ("		<TD CLASS=""dgHeaderCell"" Width=""5%"">FINP</TD>" & VbCrLf)
					Response.Write ("	</TR>")
					...
					Do While Not oRs.EOF
						...
						Response.Write ("		<TD CLASS=""dgItemCell"" align=""center"">" & oRs("FINP") & "</TD>" & VbCrLf)
						Response.Write ("	</TR>")
						...
						intPDDG = intPDGG + oRs("PDDG") : intSELL = intSELL + oRs("SELL") :	intCOMM = intCOMM + oRs("COMM")
						intTEAM = intTEAM + oRs("TEAM") : intLEAD = intLEAD + oRs("LEAD") :	intTIME = intTIME + oRs("TIME")
						intDRMA = intDRMA + oRs("DRMA") : intFINP = intFINP + oRs("FINP")
					oRS.MoveNext
					Loop
					...
					Response.Write ("		<TD CLASS=""dgHeaderCell"" Width=""5%"">" & intFINP & "</TD>" & VbCrLf)
					Response.Write ("	</TR>")
