	...
	Else
		...
		Else %>
			...
			<table border="0" cellspacing="0" cellpadding="6" width="100%">
				<tr>
					<td valign="top" align="center" width="32"><a href="javascript:confirmPDIPDFCreation()"><img src="images/Print<%=strLanguageCode%>.gif" alt="" width="40" height="36" /></a></td>
					<td valign="top">
<%
...
<%
					Response.Write "<h2>"
					If intResellerID = 2 Then
						Response.Write strTextPurchaseACustomizedDreamAssessment
					Else
					...
					Response.Write "<p>"
					If intResellerID = 2 Then
						Response.Write strTextAfterTakingTheDISCProfileSystemYouMayPurchase
						Response.Write "<ul>"
						Response.Write "<li><a href=""DGAssessment.asp?res=" & intResellerID & """>"
						Response.Write strTextDreamAssessmentReportRegMark & "</a></li>"
						Response.Write "</ul>"
					Else
			...
			<table border="0" cellspacing="0" cellpadding="6" width="100%">
				<tr>
					<td valign="top" align="center" width="32"><img src="images/Print<%=strLanguageCode%>.gif" alt="" width="32" height="32" /></td>
					<td valign="top">
<%
					Response.Write "<h2>"
					If intResellerID = 2 Then
