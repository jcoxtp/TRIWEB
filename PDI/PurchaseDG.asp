...
<div style="position:absolute;top:22px;left:280px;border-top:1px red solid;border-bottom:1px red solid;color:red;font-size:12pt;font-weight:bold">Spring Special: $25</div>
<%	End If %>
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	<tr>
		<td valign="top">
			<span class="headertext">Purchase an Assessment</span>
		</td>
...
<div align="center">
<table class="addtable" border="0" cellspacing="0" cellpadding="6" width="500">
	<tr>
		<td valign="middle" align="left">
			If you wish to take the Personal DISCernment Inventory<sup>&reg;</sup> and receive a personalized Dream Assessment<sup>&reg;</sup>, please click the <strong>Continue</strong> button. This will take you to the shopping cart to enter your credit card information to purchase The Dream Assessment® for $35.
		</td>
		<td valign="middle" align="left">
			<input type="submit" value="Continue" id="add" name="add" onClick="submitIt();">
		</td>
	</tr>
		<td valign="middle" align="left">
			If you want to purchase multiple copies of the test and report (for more than one person), please <a href="purchasetest.asp?res=<%=intResellerID%>">click here</a>.
		</td>
		<td></td>
	</tr>
</table>
...
<div align="center">
<table class="addtable" border="0" cellspacing="0" cellpadding="5" width="600">
	<tr>
		<td align="right" valign="top" width="25%"><a href="http://www.adobe.com/products/acrobat/readstep2.html" target="_blank"><img src="images/GetAcrobatReader.gif"></a></td>
		<td valign="top" align="left" width="75%"><strong>NOTE:</strong> You must have Adobe<sup>&reg;</sup> Acrobat<sup>&reg;</sup> Reader<sup>&reg;</sup> installed to view your reports. Please <a href="http://www.adobe.com/products/acrobat/readstep2.html" target="_blank">download</a> this free program from the Adobe website.</td>
	</tr>
</table>
</div>
