...
%>
		<TABLE WIDTH="612" BORDER="0" align="center" CELLPADDING="0" CELLSPACING="0">
			<TR>
				<TD COLSPAN="4"><IMG SRC="images/change_pdf_cover_01.gif" WIDTH="612" HEIGHT="44" ALT=""></TD>
			</TR>
			<TR>
				<TD><IMG SRC="images/change_pdf_cover_02.gif" WIDTH="37" HEIGHT="282" ALT=""></TD>
				<TD COLSPAN="2"><IMG SRC="images/change_pdf_cover_03.jpg" WIDTH="407" HEIGHT="282" ALT=""></TD>
				<TD><IMG SRC="images/change_pdf_cover_04.gif" WIDTH="168" HEIGHT="282" ALT=""></TD>
			</TR>
			<TR>
				<TD COLSPAN="4"><IMG SRC="images/<%=strLanguageCode%>/change_pdf_cover_05.gif" WIDTH=612 HEIGHT=125 ALT=""></TD>
			</TR>
			<TR>
				<TD background="images/change_pdf_cover_06.gif" WIDTH="612" HEIGHT="261" COLSPAN="4"><%=UserName%><br>
					<%=TestDate%>
				</TD>
			</TR>
			<TR>
				<TD COLSPAN="2"><IMG SRC="images/<%=strLanguageCode%>/PDICover.gif" WIDTH=127 HEIGHT=80 ALT=""></TD>
				<TD COLSPAN="2"><IMG SRC="images/change_pdf_cover_08.gif" WIDTH="485" HEIGHT="80" ALT=""></TD>
			</TR>
			<TR>
...
<!-- END OF Cover Page --------------------------------------------------------------------------------->
	...
	<h2>Leading others in a Changing World</h2>
	
	<p>
		Change is never easy&#151;whether on an organizational or personal level. But, like it or not, today’s world and today’s businesses are all about change. One author has observed that we live in a moment in history where change is so accelerated that we grasp the present only when it is already disappearing. Another change expert suggests that the vary definition of change&#151;creating something new&#151;always demands leadership of some kind.
	</p>
	
	<p>
		Change comes from breakthrough ideas, technological innovation, new legislation from government mandates, shifts in demographics, external competition, media hype, or increasing pressure from customers, clients, shareholders, and suppliers. And, change sometimes occurs on a grand scale due to major shifts in societal paradigms. Whatever the reason, change is a part of each of our lives.
	</p>


	<p>
		In a world where change occurs at a faster pace with each passing year, those who <em>lead</em> companies must focus on the task of bringing about change in the face of a huge range of responses, from excitement and optimism to resistance, cynicism, and confusion from those who are impacted by the change, both personally and professionally.  
	</p>
	

	<p>
		Those who have the responsibility to lead change often make the mistake of assuming that once everyone sees that the change is inevitable, everyone will get on board with the new initiative and move forward together. They believe that everyone should see this change as critical and desirable if the organization is going to survive and thrive. In reality, change occurs within one person at a time, everyone may embrace the change at different levels and at different speed.  
	</p>


	<p>
		Many models are available to depict the change process, and most of these models attest to the fact that change is a process occurring in stages and affecting people in a variety of ways. In many cases, the models see change as a four-phase progression that includes reactions ranging from denial and anger to acceptance and commitment. However, in almost every case, change is at best uncomfortable and disconcerting and at worst traumatic and debilitating, and people facing change rarely move forward in a smoothly orchestrated transition from current to future state. Many factors influence the way we accept or resist change, not the least of which is our personality.
	</p>


	<p>
		The change leader’s role is critical to decreasing both the time and the discomfort of that cycle.  To accomplish this goal, those who lead change must effectively execute four functions:
	</p>

	<p>
		<b><em>Direction:</em></b>  Presenting the vision of <em>where</em> the change will take the company.  In setting direction, leaders must let people know that the change is real, immediate, and urgent. Clear direction makes denial on the part of those affected less intense and less protracted.
	</p>
	<p>
		<b><em>Communication:</em></b>  Explaining <em>what</em> is changing, <em>why</em> the change must occur, <em>when</em> the change will take place, and <em>how</em> the change will affect both the organization and the individuals within that organization. Communication includes dealing with anger, sadness, frustration, excitement, and elation&#151;all the different reactions that the change may evoke. In the communication stage, leaders of change listen to various reactions, answer questions, and describe exactly how the change will affect everyone and the organization. 
	</p>
	...
	<p>
		<b><em>Implementation:</em></b>  Supplying the tools and resources necessary to allow those affected by change to gain all the information they need, learn the process, develop the skills, understand their roles, and carry out the duties critical to moving the organization from current to future state.
	</p>


	<p>
		<b><em>Facilitation:</em></b>  Engaging others by providing the empowerment, understanding, encouragement, coaching, and overall leadership to bring people from wherever they are in the process to where they need to be, giving them confidence and creating a path to the individual commitment critical to the initiative’s success.  
	</p>


	<p>
		These four functions lay out a simple framework that effectively helps leaders guide others through change efforts. Most, if not all, change processes go through these four phases. Successful change leaders understand that even with a clear understanding of the process, they must have equal clarity about the people they lead and recognize that change moves people out of their comfort zones and is fraught with difficulties and pitfalls. The more leaders understand themselves and others, the better their chances of moving forward toward a positive future. 
	</p>

	<h2>Leading Change and Style</h2>

	<p>
		How effectively we lead others through change depends on a number of factors&#151;our confidence in the efficacy of the change, our ability to communicate our ideas, our empathy for those on whom the change may be imposed, our realistic understanding of what difficulties and opportunities the change will create. 
	</p>
	<p>
		One of the most significant variants in the way we bring about change is our personal style&#151;how we relate to others and how we prefer to give and receive feedback. Particularly when we are under stress, we tend to present information in the way that we would prefer to receive it, and we are often wrong in assuming that others need the same approach from us. 
	</p>
	<p>
		Some leaders, based on their own personalities, may move too quickly or too slowly through the process. Others may downplay the risks and focus only on rewards, while still others present change as difficult and painful, concentrating on the challenges and pitfalls of doing things wrong. Further, a leader’s natural approach to change may resonate perfectly with certain followers and send others into a full-scale panic. 
	</p>


	<p>
		When you completed the Personal DISCernment® Inventory (PDI), you discovered that the more you know about yourself and others, the more accurately you can anticipate behavior and, therefore, better relate to other people. The PDI also helped you discover how and why people are likely to behave in one way or another and how well they respond to change, stress, and conflict.  
	</p>

	<p>
		In this application module, you will recognize how your style helps or hinders you in leading others through change&#151;in Direction, Communication, Implementation, and Facilitation. You will also identify ways to adapt your style to meet the particular needs of those who are facing change under your leadership.  
	</p>

	<p>
		No one style is perfectly adapted to leading change.  Each style has specific strengths and challenges that will come to the forefront during times of organizational change and upheaval. And, each style can be successful in bringing about change in a positive way. As you proceed through this module, you will gain insights about yourself and others and discover the untapped potential within you and the people who will accompany you on the change journey. 
	</p>


	<DIV style="PAGE-BREAK-AFTER: always">&nbsp;</DIV>
	<!-- Page 3 How this application module can help -->


	<h2>How this Application Module Can Help</h2>

	<p>
		Leading Change with Style will help you understand your personal Change leadership DISC profile. You will identify how your style potentially helps or hinders you in delivering messages and achieving your objectives as you:
	</p>
	...
	<p>
		What about the requirements and demands of those who receive your messages? How can you work within the strengths and limitations of your style to adapt to the particular needs of your audience? This application module can help you discover how to communicate effectively in order to meet the challenges of change in any organization.
	</p>
...
<!-- Start of old Communicating to be deleted ------------------>
