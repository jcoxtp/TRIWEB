...
With oCmd
	...
	.Parameters.Append .CreateParameter("@ChartTypeID", 3, 1, 4, 1)
...
' Do this so the chart won't recalibrate the Y axis and show the
' datapoints in different locations depending on max and min values
...
objChart.SetBackgroundPicture(Application("ChartBackgroundDir") & "most_small.bmp")

'Response.Write Application("ChartBackgroundDir") & "most_small.bmp"
'Response.End
