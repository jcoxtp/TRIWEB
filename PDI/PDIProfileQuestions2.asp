...
' Set initial critical page parameters
	...
	intPageID = 45	' PDI Profile Questions 2 Page
%>
...
<div id="tabgraphic">
	...
	<img src="images/S1P2<%=strLanguageCode%>.gif" alt="" width="692" height="82" usemap="#tab" />
	<map name="tab">
...
<%
	...
	' Page 2
	Words(nWord) = strTextConscientious
	DISC(nWord) = "C"
	nWord = nWord + 1
	Words(nWord) = strTextCompanionable
	DISC(nWord) = "I"
	nWord = nWord + 1
	Words(nWord) = strTextKind
	DISC(nWord) = "S"
	nWord = nWord + 1
	Words(nWord) = strTextSelfReliant
	DISC(nWord) = "D"
	nWord = nWord + 1
	
	Words(nWord) = strTextContented
	DISC(nWord) = "S"
	nWord = nWord + 1
	Words(nWord) = strTextImpatient
	DISC(nWord) = "D"
	nWord = nWord + 1
	Words(nWord) = strTextConvincing
	DISC(nWord) = "I"
	nWord = nWord + 1
	Words(nWord) = strTextResigned
	DISC(nWord) = "C"
	nWord = nWord + 1
	
	Words(nWord) = strTextAgreeable
	DISC(nWord) = "C"
	nWord = nWord + 1
	Words(nWord) = strTextSelfControlled
	DISC(nWord) = "S"
	nWord = nWord + 1
	Words(nWord) = strTextPlayful
	DISC(nWord) = "I"
	nWord = nWord + 1
	Words(nWord) = strTextPersistent
	DISC(nWord) = "D"
	nWord = nWord + 1
	
	Words(nWord) = strTextRespectful
	DISC(nWord) = "C"
	nWord = nWord + 1
	Words(nWord) = strTextGoodMixer
	DISC(nWord) = "I"
	nWord = nWord + 1
	Words(nWord) = strTextAggressive
	DISC(nWord) = "D"
	nWord = nWord + 1
	Words(nWord) = strTextGentle
	DISC(nWord) = "S"
	nWord = nWord + 1
	
	Words(nWord) = strTextHighSpirited
	DISC(nWord) = "D"
	nWord = nWord + 1
	Words(nWord) = strTextTalkative
	DISC(nWord) = "I"
	nWord = nWord + 1
	Words(nWord) = strTextGoodNatured
	DISC(nWord) = "S"
	nWord = nWord + 1
	Words(nWord) = strTextConservative
	DISC(nWord) = "C"
	nWord = nWord + 1
	
	Words(nWord) = strTextPoised
	DISC(nWord) = "I"
	nWord = nWord + 1
	Words(nWord) = strTextConventional
	DISC(nWord) = "C"
	nWord = nWord + 1
	Words(nWord) = strTextTakesRisks
	DISC(nWord) = "D"
	nWord = nWord + 1
	Words(nWord) = strTextAccommodating
	DISC(nWord) = "S"
	nWord = nWord + 1
	...
	If Submitted = "1" Then
		...
		If PREV = "1" Then
			Response.Redirect("PDIProfileQuestions1.asp?TCID=" & TestCodeID & "&res=" & intResellerID & "&lid=" & intLanguageID)
		Else
