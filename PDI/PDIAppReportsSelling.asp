...
' Set initial critical page parameters
	...
	intPageID = 13	' Selling with Style Page
%>
    ...
    <div id="main">
        ...
        <table class="addtable" border="0" cellspacing="0" cellpadding="6" width="100%">
	        <tr>
		        ...
		        <td valign="top">
			        <h2><%=strTextSellingWithStyleRegMark%></h2>
			        <p><%=strTextSellingWithStylePar1%></p>
		        </td>
	        </tr>
        </table>
        ...
        <table class="addtable" border="0" cellspacing="0" cellpadding="3" width="450">
	        ...
	        <tr>
		        <td valign="middle" align="center"><a href="javascript:openAnyWindow('PDIAppReportsSellingSample1.asp?res=<%=intResellerID%>','Sample',525,550)"><img src="images/sellingstyle_sample1_sm.gif" class="imageborder" alt="" width="200" height="254" /></a><br />
			        <span class="captiontext"><%=strTextClickImageForEnlargedView%></span>
		        </td>
		        <td valign="middle" align="center"><a href="javascript:openAnyWindow('PDIAppReportsSellingSample2.asp?res=<%=intResellerID%>','Sample',525,550)"><img src="images/sellingstyle_sample2_sm.gif" class="imageborder" alt="" width="200" height="254" /></a><br />
			        <span class="captiontext"><%=strTextClickImageForEnlargedView%></span>
		        </td>
	        </tr>
        </table>
