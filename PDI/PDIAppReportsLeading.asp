...
' Set initial critical page parameters
	...
	intPageID = 19	' Leading with Style Page
%>
...
<table class="addtable" border="0" cellspacing="0" cellpadding="6" width="100%">
	<tr>
		...
		<td valign="top">
			<h2><%=strTextLeadingWithStyleRegMark%></h2>
			<p><%=strTextLeadingWithStylePar1%></p>
		</td>
	</tr>
</table>
...
<table class="addtable" border="0" cellspacing="0" cellpadding="3" width="450">
	...
	<tr>
		<td valign="middle" align="center"><a href="javascript:openAnyWindow('PDIAppReportsLeadingSample1.asp?res=<%=intResellerID%>','Sample',525,580)"><img src="images/leadingstyle_sample1_sm.gif" class="imageborder" alt="" width="200" height="254" /></a><br />
			<span class="captiontext"><%=strTextClickImageForEnlargedView%></span>
		</td>
		<td valign="middle" align="center"><a href="javascript:openAnyWindow('PDIAppReportsLeadingSample2.asp?res=<%=intResellerID%>','Sample',525,580)"><img src="images/leadingstyle_sample2_sm.gif" class="imageborder" alt="" width="200" height="254" /></a><br />
			<span class="captiontext"><%=strTextClickImageForEnlargedView%></span>
		</td>
	</tr>
</table>
