...
<%
	...
	If FileExists = 0 Then
		...
		With oCmd
			.CommandText = "spPurchaseTestCodeAppModuleFileCreatedUpdate"
			.CommandType = 4
		...
		If oConn.Errors.Count > 0 Then
			Response.Write strTextUnableToUpdateDatabaseThatFileWasCreated & " "
			Response.Write " " & strTextTheErrorMessageIs & ": "
			Response.Write "<br>"
