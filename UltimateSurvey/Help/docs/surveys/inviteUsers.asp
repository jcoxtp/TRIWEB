...
<p class="help-title">Invite Users</p>
<hr color="#000000" size="1">
<p class="help-body"><span class="normal">This page is used to control which users have access to restricted surveys*
...
<span class="normal">*RESTRICTED SURVEY - a survey that only users specified through the "Invite Users" interface can take</span></p>
</body>
