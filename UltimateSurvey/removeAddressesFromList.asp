...
<%
	...
	Call user_getSessionInfo("", intUserType, "","", "")
	...
	<form method="get" action="editList.asp" id=form1 name=form1>
		...
		<tr><td width="15%">
			<a href="addAddressesToList.asp?listID=<%=intListID%>">
					<img src="images/button-addAddresses.gif" alt="Add Addresses" border="0" width="125" height="17"></a>
			</td>
...
%>
		...
		<form method="post" action="editList.asp?listID=<%=intListID%>&pageNumber=<%=intPageNumber%>">
