		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE align="center" id="Table1" cellSpacing="1" cellPadding="1" border="0">
				<TR>
					...
					<TD class="style1" align="left">Click on the pattern below 
						that matches your DISC chart on the left<br></TD>
					<TD></TD>
				</TR>
				<tr><td colspan=3>&nbsp;</td></tr>
				<TR>
					<TD style="PADDING-RIGHT: 15px;PADDING-LEFT: 5px;PADDING-BOTTOM: 5px;WIDTH: 272px;PADDING-TOP: 5px"
						vAlign="top" align="left">
						<div style="PADDING-RIGHT:25px;FLOAT:left;PADDING-BOTTOM:5px"><asp:Image id="imgComposite" runat="server"></asp:Image></div>
						&nbsp;Look at your DISC graph (left)&nbsp;and find the pattern in the 
						Representative Patterns Chart (right)&nbsp;that is the closest match. It 
						doesn't have to be exactly the same shape, but pay particular attention to 
						which elements (D,I,S, and C) are above or below the center line.<BR>
						<BR>
						...
						<asp:Repeater id="rptSuggestions" runat="server">
							...
							<ItemTemplate>
								<li>
									<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&index=<%# Container.DataItem %>">
					...
					<TD align="left" valign="top">
						<div id="canvas" style="WIDTH:5px;POSITION:relative;HEIGHT:5px">
							<img id="imgRepChart" style="BORDER-RIGHT:0px; BORDER-TOP:0px; BORDER-LEFT:0px; BORDER-BOTTOM:0px"
								src="images/en/chart.GIF"> <a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=1" style="LEFT:59px; POSITION:absolute; TOP:9px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=2" style="LEFT:143px; POSITION:absolute; TOP:10px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=3" style="LEFT:226px; POSITION:absolute; TOP:11px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=4" style="LEFT:12px; POSITION:absolute; TOP:132px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=5" style="LEFT:101px; POSITION:absolute; TOP:133px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=6" style="LEFT:216px; POSITION:absolute; TOP:119px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=7" style="LEFT:343px; POSITION:absolute; TOP:9px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=8" style="LEFT:425px; POSITION:absolute; TOP:10px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=9" style="LEFT:508px; POSITION:absolute; TOP:12px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=10" style="LEFT:591px; POSITION:absolute; TOP:58px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=11" style="LEFT:491px; POSITION:absolute; TOP:149px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=12" style="LEFT:589px; POSITION:absolute; TOP:145px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=13" style="LEFT:395px; POSITION:absolute; TOP:120px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=14" style="LEFT:599px; POSITION:absolute; TOP:247px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=15" style="LEFT:494px; POSITION:absolute; TOP:254px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=16" style="LEFT:596px; POSITION:absolute; TOP:348px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=17" style="LEFT:522px; POSITION:absolute; TOP:393px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=18" style="LEFT:442px; POSITION:absolute; TOP:394px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=19" style="LEFT:349px; POSITION:absolute; TOP:392px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=20" style="LEFT:372px; POSITION:absolute; TOP:290px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=21" style="LEFT:13px; POSITION:absolute; TOP:250px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=22" style="LEFT:116px; POSITION:absolute; TOP:253px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=23" style="LEFT:95px; POSITION:absolute; TOP:398px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=24" style="LEFT:181px; POSITION:absolute; TOP:397px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=25" style="LEFT:262px; POSITION:absolute; TOP:395px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=26" style="LEFT:7px; POSITION:absolute; TOP:352px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=27" style="LEFT:233px; POSITION:absolute; TOP:278px"
							...
							<a href="RepPatternDesc.aspx?tc=<%= TestCode %>&amp;index=28" style="LEFT:303px; POSITION:absolute; TOP:204px"
