...
******************************************************************************************************/
		...
		{	
			...
			pp.document.writeln('<TABLE width=100%><TR><TD></TD></TR><TR><TD align=right><a ID="PRINT" href="javascript:location.reload(true);window.print();">Print</a>&nbsp;&nbsp;&nbsp;<a ID="CLOSE" href="window.close();">Close Window</a></TD></TR><TR><TD></TD></TR></TABLE>');
