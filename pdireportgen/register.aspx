	...
	<body>
		<form id="Form1" method="post" runat="server">
			...
			<TABLE align="center" id="Table1" cellSpacing="1" cellPadding="1" border="0">
				<TR>
					<TD width="120">&nbsp;</TD>
					<TD align="center"><%= getHTML("register.inc") %>&nbsp;</TD>
					<TD width="120">&nbsp;</TD>
				</TR>
				<TR>
					<TD>&nbsp;</TD>
					<TD align="center"><TABLE id="tblUserInfo" cellSpacing="4" cellPadding="1" border="0" style="BORDER-RIGHT: #435b69 1px solid; BORDER-TOP: #435b69 1px solid; BORDER-LEFT: #435b69 1px solid; BORDER-BOTTOM: #435b69 1px solid"
							width="400">
							<TR>
								<TD colspan="3">&nbsp;</td>
							</TR>
