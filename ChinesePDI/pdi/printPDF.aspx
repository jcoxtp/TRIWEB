...
<script runat="server">
	...
	private void createPDF()
	{
		...
		theDoc.Save("C:\\PDFReports\\" + reportFile);

		theDoc.Clear(); 
		theDoc.HtmlOptions.PageCacheClear();
		
		string pdfReportPath = "/PDFReports/";
	...
	{
        string connectionString = "Data Source=216.52.198.215,1433;Network Library=DBMSSOCN;Trusted_Connection=False;Initial Catalog=TeamResources;User Id=sa;Password=s3rv3r pa33word!;";
