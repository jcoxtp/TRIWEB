...
<tr>
	...
	<td valign="top" class="maincontent">
		...
		%>
		<form name="thisForm" id="thisForm" method="post" action="ProfileManagersAddNew.asp?res=<%=intResellerID%>">
		<h1>Create a New Profile Manager</h1><hr>
		<table border="0" cellpadding="5" cellspacing="3" width="" class="dgDataGrid">
			<tr class="dgAltItemRow">
				<td valign="top">
					<b>To Create a New Profile Manager follow these steps:</b><br><br>
					<ol type="1">
						<li>Enter text in the box below related to the user you wish to make a profile manager and click "Search for Users".  
						...
						and click the "Make Manager" link next to their username.
					</ol>
				</td>
			</tr>
			<tr class="dgAltItemRow">
		...
		<%
			If ((bFilledOutProperly) and (bSubmitted = 1)) Then
				...
				If oConn.Errors.Count < 1 then
					...
					Response.Write ("		<TD CLASS=""dgHeaderCell"" nowrap> Password </TD>" & VbCrLf)
					...
					Do While Not oRs.EOF
						...
						Response.Write ("		<TD CLASS=""dgItemCell"" align=""left"" nowrap>" & oRs("Password") & "</TD>" & VbCrLf)
						Response.Write ("		<TD CLASS=""dgItemCell"" align=""left"" nowrap><a href=""ProfileManagersAddNewProcessor.asp?res=" & intResellerID & "&NewPMuid=" & oRs("UserID") & """>Make Manager</a></TD>" & VbCrLf)
						Response.Write ("	</TR>")
					oRS.MoveNext
					Loop
