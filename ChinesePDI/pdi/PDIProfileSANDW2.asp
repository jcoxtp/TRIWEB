...
<html>
<head>
	<title>DISC Profile System | Possible Weaknesses</title>
...
<div id="tabgraphic">
	<img src="images/s5p3.gif" width="692" height="82" alt="" usemap="#tab" />
	<map name="tab">
		<area shape="poly" alt="" coords="567,53,607,53,613,58,610,65,565,65,550,58,568,53,570,53" href="PDIProfileSANDW1.asp?res=<%=intResellerID%>&TCID=<%=TestCodeID%>">
		<area shape="poly" alt="" coords="624,53,662,53,677,59,663,65,625,66,616,60,623,53,625,53" href="PDIProfileQuit.asp?res=<%=intResellerID%>&TCID=<%=TestCodeID%>">
	</map>
</div>
