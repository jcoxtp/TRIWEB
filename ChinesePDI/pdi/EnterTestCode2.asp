...
<%
	...
	If bSubmitted <> "" AND bFilledOutProperly Then
		...
		With oCmd
			.CommandText = "sel_TestCode_Test2"
			.CommandType = 4
			...
			If oRs.EOF = FALSE then
				...
				Else
					If Left(TestCodeEntered,4) = "PDIP" Or Left(TestCodeEntered,3) = "个性鉴" Then
						Response.Redirect("PDIProfileStartPage2.asp?TCID=" & TestCodeID & "&res=" & intResellerID)
					Else
						Response.Redirect("AppModuleCreatePDF2.asp?TCID=" & TestCodeID & "&res=" & intResellerID)
					End If
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" ID="Table1">
		<tr>
			...
			<td valign="top" align="right"><a href="main.asp?res=<%=intResellerID%>"><img src="images/back.gif" alt="" width="73" height="16" border="0" /></a></td>
		</tr>
	</table>
	
	<p>如果你已有鉴别系统的密码，现在就想使用，请在下面键入：</p>
	
	<form name="thisForm" id="thisForm" method="post" action="EnterTestCode2.asp?res=<%=intResellerID%>">
