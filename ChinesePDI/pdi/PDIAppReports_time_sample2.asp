...
<html>
<head>
	<title>Time Management With Style&reg; | Sample 2</title>
...
<table border="0" cellspacing="0" cellpadding="3">
	<tr>			
		...
		<td valign="top"><a href="PDIAppReports_time_sample1.asp?res=<%=intResellerID%>"><img src="images/back.gif" alt="" width="73" height="16" /></a></td>
	</tr>
</table>
</div>
</body>
