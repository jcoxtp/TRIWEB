...
<head>
	...
	<title>DISC Profile System | PDI Profile Questions 3</title>
	...
	If Submitted = "1" Then
		...
		If oConn.Errors.Count > 0 Then
			...
			Response.Write "<br>"
			Response.Write "Unable to record answers in database. Please try again."
			Response.End
		End If
		...
		Else
			Response.Redirect("PDIProfileQuestions4.asp?TCID=" & TestCodeID & "&res=" & intResellerID)
		End If
	Else
		' Every question page must aquire the the test code id
		If TEstCodeID = "" Then
			Response.Write "Invalid test code id. The test cannot be started."
			Response.End
		End If
	End If
				...
				While oRs.EOF = FALSE
					If CInt(oRs("QuestionNumber")) = 25 Then
						...
						If oRs("Answer") = "I" Then
							Response.Write "document.form1.chkMostAns1.checked = true;"	
						ElseIf oRs("Answer") = "C" Then
							Response.Write "document.form1.chkMostAns2.checked = true;"	
						ElseIf oRs("Answer") = "D" Then
							Response.Write "document.form1.chkMostAns3.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkMostAns4.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 26 Then
						If oRs("Answer") = "I" Then
							Response.Write "document.form1.chkLeastAns1.checked = true;"	
						ElseIf oRs("Answer") = "C" Then
							Response.Write "document.form1.chkLeastAns2.checked = true;"	
						ElseIf oRs("Answer") = "D" Then
							Response.Write "document.form1.chkLeastAns3.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkLeastAns4.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 27 Then
						If oRs("Answer") = "I" Then
							Response.Write "document.form1.chkMostAns5.checked = true;"	
						ElseIf oRs("Answer") = "D" Then
							Response.Write "document.form1.chkMostAns6.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkMostAns7.checked = true;"	
						ElseIf oRs("Answer") = "C" Then
							Response.Write "document.form1.chkMostAns8.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 28 Then
						If oRs("Answer") = "I" Then
							Response.Write "document.form1.chkLeastAns5.checked = true;"	
						ElseIf oRs("Answer") = "D" Then
							Response.Write "document.form1.chkLeastAns6.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkLeastAns7.checked = true;"	
						ElseIf oRs("Answer") = "C" Then
							Response.Write "document.form1.chkLeastAns8.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 29 Then
						If oRs("Answer") = "D" Then
							Response.Write "document.form1.chkMostAns9.checked = true;"	
						ElseIf oRs("Answer") = "C" Then
							Response.Write "document.form1.chkMostAns10.checked = true;"	
						ElseIf oRs("Answer") = "I" Then
							Response.Write "document.form1.chkMostAns11.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkMostAns12.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 30 Then
						If oRs("Answer") = "D" Then
							Response.Write "document.form1.chkLeastAns9.checked = true;"	
						ElseIf oRs("Answer") = "C" Then
							Response.Write "document.form1.chkLeastAns10.checked = true;"	
						ElseIf oRs("Answer") = "I" Then
							Response.Write "document.form1.chkLeastAns11.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkLeastAns12.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 31 Then
						If oRs("Answer") = "D" Then
							Response.Write "document.form1.chkMostAns13.checked = true;"	
						ElseIf oRs("Answer") = "I" Then
							Response.Write "document.form1.chkMostAns14.checked = true;"	
						ElseIf oRs("Answer") = "C" Then
							Response.Write "document.form1.chkMostAns15.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkMostAns16.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 32 Then
						If oRs("Answer") = "D" Then
							Response.Write "document.form1.chkLeastAns13.checked = true;"	
						ElseIf oRs("Answer") = "I" Then
							Response.Write "document.form1.chkLeastAns14.checked = true;"	
						ElseIf oRs("Answer") = "C" Then
							Response.Write "document.form1.chkLeastAns15.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkLeastAns16.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 33 Then
						If oRs("Answer") = "C" Then
							Response.Write "document.form1.chkMostAns17.checked = true;"	
						ElseIf oRs("Answer") = "D" Then
							Response.Write "document.form1.chkMostAns18.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkMostAns19.checked = true;"	
						ElseIf oRs("Answer") = "I" Then
							Response.Write "document.form1.chkMostAns20.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 34 Then
						If oRs("Answer") = "C" Then
							Response.Write "document.form1.chkLeastAns17.checked = true;"	
						ElseIf oRs("Answer") = "D" Then
							Response.Write "document.form1.chkLeastAns18.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkLeastAns19.checked = true;"	
						ElseIf oRs("Answer") = "I" Then
							Response.Write "document.form1.chkLeastAns20.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 35 Then
						If oRs("Answer") = "C" Then
							Response.Write "document.form1.chkMostAns21.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkMostAns22.checked = true;"	
						ElseIf oRs("Answer") = "I" Then
							Response.Write "document.form1.chkMostAns23.checked = true;"	
						ElseIf oRs("Answer") = "D" Then
							Response.Write "document.form1.chkMostAns24.checked = true;"	
						End If
					ElseIf CInt(oRs("QuestionNumber")) = 36 Then
						If oRs("Answer") = "C" Then
							Response.Write "document.form1.chkLeastAns21.checked = true;"	
						ElseIf oRs("Answer") = "S" Then
							Response.Write "document.form1.chkLeastAns22.checked = true;"	
						ElseIf oRs("Answer") = "I" Then
							Response.Write "document.form1.chkLeastAns23.checked = true;"	
						ElseIf oRs("Answer") = "D" Then
							Response.Write "document.form1.chkLeastAns24.checked = true;"	
						End If
					End If 			
					oRs.MoveNext
				Wend
...
<div id="tabgraphic">
	...
	<img src="images/s1Loading.gif" name="statusImage" width="692" height="82" alt="" usemap="#tab" />
	<map name="tab">
